															...
															<table class="TableContent" width="100%">
																<tr>
																	<td><table style="width:100%;text-align:center">
																			<tr>
																				<td><a href="" target="_blank" type="application/octet-stream" target="_top"><img style="width:180px;height:180px;border:0px" src="'.$layout_name.'/images/account/download_windows.png"/></a></td>
																				<td><a href="https://static.otland.net/ipchanger.exe" target="_blank" type="application/octet-stream" target="_top"><img style="width:180px;height:180px;border:0px" src="'.$layout_name.'/images/account/download_linux.png"/><br/>
																					</a></td>
																			</tr>
																			<tr>
																			
																			<td valign="top"><a href="" target="_blank" type="application/octet-stream" target="_top">Client 10.00</a> |
																				<a href="https://tibiamaps.io/downloads" target="_blank" type="application/octet-stream" target="_top"> Minimap</a></br>
																				<a href="" target="_blank" type="application/octet-stream" target="_top">Client Próprio</a>
																				</td>
